...
view_mode = "complete"; // [complete,exploded,wooden_frame,roundwood_structure,front_panel_horizontal,front_panel_vertical,rear_panel,front_panel_inserts,wooden_panels,wooden_panels_exploded,side_clamp_guide_left,side_clamp_guide_right,aluminium_frame,aluminium_with_led_panels,clamps_lower,clamps_upper,clamps_both,corner_brackets,rubber_feet]
...
show_roundwood_frame = true;
show_roundwood_sockets = true;
show_roundwood_cross_member = true;
show_roundwood_center_supports = true;
/* [Front panel] */
...
if(view_mode=="complete") {
    display_case_assembly(
        ...
        show_rear_panel,
        true,
        show_roundwood_frame,
        show_roundwood_sockets,
        show_roundwood_cross_member,
        show_roundwood_center_supports
    );
...
} else if(view_mode=="roundwood_structure") {
